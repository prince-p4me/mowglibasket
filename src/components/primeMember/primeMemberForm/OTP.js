...
const OTP = (props) => {
    ...
    // const user_id = '123';
    // const message = 'OTP has been sent to your registred mobile number and email id';
    ...
    const onLoginSuccess = (response) => {
        ...
        if (response.data.user_info.is_prime_membership == 1 || response.data.user_info.is_prime_membership == '1') {
            props.navigation.pop(2)
            props.navigation.navigate("services")
        } else {
            navigateToSelectAddress(response)
        }
    }
