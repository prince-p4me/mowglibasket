...
const SubCategoriesShimmer = (props) => {
    ...
    const GroceryItem = ({ item, navigation }) => {
        ...
        return (
            <View style={[{ padding: 0, marginHorizontal: 3, marginTop: 5, flex: 1 }]}>
...
export default SubCategoriesShimmer