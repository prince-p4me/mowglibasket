...
import { View, FlatList, Text, Image, RefreshControl, TouchableOpacity } from 'react-native'
...
const ProductList = (props) => {
        ...
        return (
            <View>
                <View style={[MStyles.horizontal, { paddingHorizontal: 5, marginVertical: 5, alignItems: 'center', justifyContent: 'space-between' }]}>
                    <Text style={[MStyles.txtDescription]}>{data.totalItems} {ITEMS_FOUND}</Text>
    ...
    return (
        <SafeAreaView style={[MStyles.mainAuth]}>
            <ToolbarProductList {...props} 
            // title="Mowgli Basket"
             cart={cart} />
            {/* <ToolbarBack {...props} title="Mowgli Basket" cart={cart} /> */}
